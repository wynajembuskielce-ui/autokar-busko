...
const title = "Autokar na pielgrzymkę - Jasna Góra, Watykan, Medjugorje | Autokar Busko";
const description = "Wynajem autokaru na pielgrzymkę krajową i zagraniczną. 200+ parafii obsłużonych od 2003, Jasna Góra, Licheń, Watykan, Medjugorje. Tel: 41 345 32 25 lub +48 609 69 19 12.";
...
const testimonials = [
  {
    text: "Pielgrzymka parafialna na Jasną Górę, 47 osób, Autokar Busko. Kierowca Pan Krzysztof zatrzymał się przy każdym sanktuarium, które wymieniłem w planie - bez dodatkowych opłat. Spokojny, kulturalny, modlił się z nami koronką. Polecam każdej parafii.",
