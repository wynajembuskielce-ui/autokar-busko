...
const ctaTexts: Record<Language, string> = {
  pl: "Zarezerwuj autobus szkolny - +48 601 076 652 lub ",
  en: "Book school coach - +48 601 076 652 lub ",
  de: "Schulbus buchen - +48 601 076 652 lub ",
  ru: "Забронировать автобус - +48 601 076 652 lub ",
  ar: "احجز حافلة مدرسية - +48 601 076 652 lub ",
  es: "Reservar autobus escolar - +48 601 076 652 lub ",
  fr: "Reserver autocar scolaire - +48 601 076 652 lub ",
};
...
export default async function WycieczkiSzkolnePage({ params }: { params: Promise<{ lang: string }> }) {
  ...
  return (
    <>
      <HeroSection title={heroTitles[l]} subtitle={heroSubtitles[l]} ctaText={ctaTexts[l]} ctaHref="tel:601076652" backgroundImage="/images/wycieczki/wycieczka-szkolna-autokar-krakow-1.jpg" />
