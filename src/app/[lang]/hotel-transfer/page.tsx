...
const ctaTexts: Record<Language, string> = {
  pl: "Zamów transfer - +48 601 076 652 lub ",
  en: "Book transfer - +48 601 076 652 lub ",
  de: "Transfer buchen - +48 601 076 652 lub ",
...
export default async function HotelTransferPage({ params }: { params: Promise<{ lang: string }> }) {
  ...
  return (
    <>
      <HeroSection title={heroTitles[l]} subtitle={heroSubtitles[l]} ctaText={ctaTexts[l]} ctaHref="tel:601076652" backgroundImage="/images/transfer/transfer-autokar-krakow-2.jpg" />
