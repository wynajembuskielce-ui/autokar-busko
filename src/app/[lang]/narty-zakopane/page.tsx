...
const ctaTexts: Record<Language, string> = {
  pl: "Zarezerwuj wyjazd narciarski - +48 601 076 652 lub ",
  en: "Book ski trip - +48 601 076 652 lub ",
  de: "Skifahrt buchen - +48 601 076 652 lub ",
  ru: "Забронировать выезд - +48 601 076 652 lub ",
  ar: "احجز رحلة التزلج - +48 601 076 652 lub ",
  es: "Reservar viaje de esqui - +48 601 076 652 lub ",
  fr: "Reserver sortie ski - +48 601 076 652 lub ",
};
...
export default async function NartyZakopanePage({ params }: { params: Promise<{ lang: string }> }) {
  ...
  return (
    <>
      <HeroSection title={heroTitles[l]} subtitle={heroSubtitles[l]} ctaText={ctaTexts[l]} ctaHref="tel:601076652" backgroundImage="/images/narty/narty-bus-krakow-zakopane-1.jpg" />
