...
const testimonials = [
  {
    text: "Trzecia wycieczka z MUSZKIETEREM w tym roku przedszkolnym. Pan kierowca Krzysztof zawsze ten sam - dzieci go znają, nie boją się. Apteczka pełna, autokar czysty, klimatyzacja działa. Polecam.",
