...
const title = "Autokar na wycieczkę liceum - 3-7 dni, krajowa i zagraniczna | Autokar Busko";
const description = "Wynajem autokaru na wycieczkę liceum: maturalną, integracyjną, językową. 40+ szkół rocznie, 2 kierowcy na trasy >9h, cała Europa. Tel: 41 345 32 25.";
